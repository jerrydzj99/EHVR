...
//Name: Cockpit.ma
//Last modified: Mon, Nov 04, 2019 07:52:57 PM
//Codeset: UTF-8
requires maya "2019";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.1132694638169935 7.4492364006479859 15.903848625020601 ;
	setAttr ".r" -type "double3" -32.138352732824877 -347.00000000020725 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "DFDCC4ED-A84E-6FD5-016C-7FB276AFFEB0";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 10.730948628841979;
...
createNode transform -s -n "top";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.3748102812545249 1000.1 4.4431947914634851 ;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 1.5340716161861974 4.6482033239931946 ;
...
createNode mesh -n "ControlsShape" -p "Controls";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.055100936442613602 0.49999997019767761 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6B5BC3C2-E741-23A8-ED54-B3ACE4452C37";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "3482233C-D84A-DCC8-6C54-C5BC0BBA2016";
createNode displayLayer -n "defaultLayer";
	rename -uid "3AAE1A9E-2D49-4675-4BDD-BA84C91ECBD2";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E0B340AE-7045-D533-3609-C384250B3764";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "91A16D07-C24C-E82D-27BA-6A9CC40D80A3";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "17761258-0742-6DA6-21FD-B687F22590E9";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "08760834-274D-F1A2-C6FC-ABB9595118B2";
...
createNode polyTweak -n "polyTweak8";
	...
	setAttr ".uopa" yes;
	setAttr -s 13 ".tk";
	setAttr ".tk[80]" -type "float3" 0 -5.5879354e-09 2.1187589e-08 ;
	setAttr ".tk[81]" -type "float3" 0 5.5879354e-09 2.1187589e-08 ;
	setAttr ".tk[82]" -type "float3" 0 -5.5879354e-09 -4.2840838e-08 ;
	setAttr ".tk[83]" -type "float3" 0 5.5879354e-09 -4.2840838e-08 ;
	setAttr ".tk[84]" -type "float3" 0.14280157 0 0 ;
	setAttr ".tk[85]" -type "float3" 0.14280157 0 0 ;
	setAttr ".tk[86]" -type "float3" 0.14280157 0 0 ;
	setAttr ".tk[87]" -type "float3" 0.14280157 0 0 ;
	setAttr ".tk[88]" -type "float3" -0.14280157 0 0 ;
	setAttr ".tk[89]" -type "float3" -0.14280157 0 0 ;
	setAttr ".tk[90]" -type "float3" -0.14280157 0 0 ;
	setAttr ".tk[91]" -type "float3" -0.14280157 0 0 ;
