...
//Last modified: Tue, Nov 12, 2019 03:55:12 PM
//Codeset: UTF-8
requires maya "2019";
requires "mtoa" "3.1.2";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.4595402421285399 10.176164572776713 9.2202429567000763 ;
	setAttr ".r" -type "double3" -42.938352317805176 3274.199999997345 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "9317FC00-CB47-34DB-2841-B484BE7ADAFA";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 14.146898480458413;
...
createNode transform -n "Divider5";
	...
	setAttr ".t" -type "double3" -14.176230409593197 0 -2.97 ;
...
createNode transform -n "Divider3";
	...
	setAttr ".t" -type "double3" -14.176290012353595 0 2.969908790826401 ;
...
createNode transform -n "Divider6";
	...
	setAttr ".t" -type "double3" -10.982322551635637 0 -3.6616881588946928 ;
...
createNode transform -n "Divider2";
	...
	setAttr ".t" -type "double3" -10.804500778072569 0 3.6212261798685055 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "044B74EF-5142-8E34-BA58-ABB268FF27C6";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "5A66302A-074B-9C88-140D-6EBB611B221A";
createNode displayLayer -n "defaultLayer";
	rename -uid "F602ABA9-0D4A-BE1C-091C-D2A9FF0CA4D8";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F4EB50E3-284F-179E-105B-12B54DF43565";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "FD38BCB3-1845-120D-8F42-BAA43C191C37";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "77DA8287-2044-1735-EB72-46A30E51F77A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "2CBC2653-AA45-3374-462C-35882F9FAE3D";
...
createNode script -n "uiConfigurationScriptNode";
	...
	setAttr ".b" -type "string" (
		...
		+ "\t\tif (!$useSceneConfig) {\n\t\t\tpanel -e -l $label $panelName;\n\t\t}\n\t}\n\n\n\tif ($useSceneConfig) {\n        string $configName = `getPanel -cwl (localizedPanelLabel(\"Current Layout\"))`;\n        if (\"\" != $configName) {\n\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-userCreated false\n\t\t\t\t-defaultImage \"\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 48 100 -ps 2 52 100 -ps 3 65 0 -ps 4 35 0 $gMainPane;\"\n\t\t\t\t-removeAllPanels\n\t\t\t\t-ap false\n\t\t\t\t\t(localizedPanelLabel(\"Top View\")) \n\t\t\t\t\t\"modelPanel\"\n"
