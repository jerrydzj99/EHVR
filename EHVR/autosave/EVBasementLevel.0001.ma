...
//Name: EVBasementLevel.0001.ma
//Last modified: Thu, Nov 21, 2019 02:10:50 PM
//Codeset: UTF-8
requires maya "2019";
requires "mtoa" "3.1.2";
currentUnit -l centimeter -a degree -t film;
fileInfo "exportedFrom" "/Users/jerryding/Desktop/EHVR/Maya Files/Basement Level/EVBasementLevel.ma";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.0904434079801177 0.55386049323956077 0.13075660786904925 ;
	setAttr ".r" -type "double3" -3.9383523237181346 3330.1999999961859 -1.0177774980683254e-13 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "9317FC00-CB47-34DB-2841-B484BE7ADAFA";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 12.581708877228527;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -1.9117041728523532 0 0.1834716796875 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "14544FE5-AF41-BF1D-0BB5-3381671155DB";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "9B42A95D-5241-5C5F-4CC4-B491C43ADDFD";
createNode displayLayer -n "defaultLayer";
	rename -uid "F602ABA9-0D4A-BE1C-091C-D2A9FF0CA4D8";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C48EACE6-4F4C-3CFD-9101-73B389C86C95";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "FD38BCB3-1845-120D-8F42-BAA43C191C37";
	setAttr ".g" yes;
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "4A517B3B-F046-74DF-B6CC-E59BC086FD11";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "262C8315-2A44-FAAA-4274-86962974021E";
...
// End of EVBasementLevel.0001.ma
